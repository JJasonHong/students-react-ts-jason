...
import AddStudentForm from "../components/AddStudentFrom";
...
const StudentDetailPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      //console.log(body);
      //body is in json format so it knows how to set the state
      setStudentInfo(body);
    };
    //the fetch data function is called when the component mounts
    fetchData();
  }, [id]);
